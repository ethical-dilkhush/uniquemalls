...
<!--parity sapre emered bcone and hr div -->
  ...
  <th><button onclick="location.href='bcon_win'"  style="color:#028881;height:40px;width:50%;float:right;background:none;border:0px;font-weight:bold">Bcone</button></th>
  <th><button onclick="location.href='emerd_win'"  style="height:40px;width:50%;float:right;background:none;border:0px;font-weight:bold">Emerd</button></th>
    ...
    <hr id="hr1" style="margin-top:0px;color:yellow;border: 1px solid #028881;width:25%;float:left;margin-left:55%">
