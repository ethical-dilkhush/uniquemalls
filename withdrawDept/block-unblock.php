...
<body id="body_gradient" style="height:100%;font-family: Roboto,sans-serif;" onload="showBlocked()">
    ...
    <div  class="header">
        &nbsp;&nbsp;&nbsp;&nbsp;<i onclick="openNav();" class="fa fa-bars" style="font-size:24px; margin-top: 19.5px; position: absolute;"></i><div style=" width:auto; margin-left:50px"><p>Block Unblock Manager</p></div>
        </div>
...
<input type="submit" name="unblock" class="logout_button" value="UNBLOCK">
...
<?php
  ...
  {
        $userd=$_POST['u_id'];
       $unblock_q = mysqli_query($conn,"UPDATE users set flag=1 where user_id='$userd'");
