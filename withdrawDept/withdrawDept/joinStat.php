...
<body id="body_gradient" style="height:100%;font-family: Roboto,sans-serif;" onload="showBlocked()">
    ...
    <div  class="header">
        &nbsp;&nbsp;&nbsp;&nbsp;<i onclick="openNav();" class="fa fa-bars" style="font-size:24px; margin-top: 19.5px; position: absolute;"></i><div style=" width:auto; margin-left:50px"><p>Joining Stats</p></div>
        </div>
