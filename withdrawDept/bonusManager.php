...
<body id="body_gradient" style="height:100%;font-family: Roboto,sans-serif;" onload="showBlocked()">
    ...
    <div  class="header">
        &nbsp;&nbsp;&nbsp;&nbsp;<i onclick="openNav();" class="fa fa-bars" style="font-size:24px; margin-top: 19.5px; position: absolute;"></i><div style=" width:auto; margin-left:50px"><p>Bonus Manager</p></div>
        </div>
...
<input type="number" name="amt" placeholder="amount" style="outline:none" required>

<br><br>
<input type="submit" name="reffral"  value="REFFRAL">
...
$amt=$_POST['amt'];
    ...
    if(isset($_POST['reffral']))
  {
      
    $reffral = mysqli_query($conn,"UPDATE admins set reffral_bonus='$amt' where id='1'");
     ...
     if(isset($_POST['signup']))
  {
    ...
    $signup = mysqli_query($conn,"UPDATE admins set signup_bonus='$amt' where id='1'");
     ...
     if(isset($_POST['withdraw']))
  {
    ...
    $withdraw = mysqli_query($conn,"UPDATE admins set min_withdraw='$amt' where id='1'");
     ...
     if(isset($_POST['recharge']))
  {
    ...
    $recharge = mysqli_query($conn,"UPDATE admins set min_recharge='$amt' where id='1'");
