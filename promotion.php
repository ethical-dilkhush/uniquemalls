   ...
   <p style="text-align:center;margin:10px;font-size:20px" >
    ...
    <div style="background-color: none;height:25px;width:100%">
        ...
        <div style="background-color:none;height:25px;float:left;width:48%">
          <center  id="lvl1" style="font-size: 20px;color:#028881;">Level 1</center>
        </div>
    ...
    <hr id="hr1" style="border:1px solid #028881;width:48%;float:left;"><hr id="hr2" style="border:1px solid #028881;width:48%;float:right;visibility:hidden">
</center>
<br>
<div>
...
<div style="margin-left: 10px;">
    ...
    <br>
    <br>
    <span id="link" style="margin-top: 10px; color: grey;font-size: 15px;">https://uniquemalls.in/person/register?r_code=<?php echo $promotionrecords['promotion_id']; ?></span>
    <hr style="margin-top: 10px;background-color: grey;">
