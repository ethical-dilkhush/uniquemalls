<?php
 ...
 $current_period = $current_period-1;
  ...
  //sum of 0
  $sql0 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='0' && section=4");
...
//sum of 1
$sql1 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='1' && section=4");
...
//sum of 2
$sql2 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='2' && section=4");
...
//sum of 3
$sql3 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='3' && section=4");
...
//sum of 4
$sql4 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='4' && section=4");
...
//sum of 5
$sql5 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='5' && section=4");
...
//sum of 6
$sql6 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='6' && section=4");
...
//sum of 7
$sql7 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='7' && section=4");
...
//sum of 8
$sql8 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='8' && section=4");
...
//sum of 9
$sql9 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='9' && section=4");
...
//sum of green
$sql11 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='11' && section=4");
...
//sum of voilet
$sql12 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='12' && section=4");
...
//sum of red
$sql13 = mysqli_query($conn,"SELECT SUM(amount) As total FROM transactions where period='$current_period' && selection='13' && section=4");
...
$update = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='$number' && section=4");
...
while($row = mysqli_fetch_array($update))
{
  ...
  mysqli_query($conn,"UPDATE transactions SET status='win' where period='$current_period' && selection='$number' && section=4");
}

//giving to color selectors
if($clr=='11')
{
    $query_color11 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='$clr' && section=4");
    while($row = mysqli_fetch_array($query_color11))
    {
      ...
      mysqli_query($conn,"UPDATE transactions SET status='win' where period='$current_period' && selection='$clr' && section=4");
    }
...
{
    $query_color13 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='$clr' && section=4");
...
{
    $query_color14 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='13' && section=4");
    while($row = mysqli_fetch_array($query_color14))
    {
      ...
      mysqli_query($conn,"UPDATE transactions SET status='win' where period='$current_period' && selection='13' && section=4");
    } 
    
    $query_color15 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='12' && section=4");
    while($row = mysqli_fetch_array($query_color15))
    {
      ...
      mysqli_query($conn,"UPDATE transactions SET status='win' where period='$current_period' && selection='12' && section=4");
    } 
...
{
    $query_color16 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='11' && section=4");
    while($row = mysqli_fetch_array($query_color16))
    {
      ...
      mysqli_query($conn,"UPDATE transactions SET status='win' where period='$current_period' && selection='11' && section=4");
    } 
    
    $query_color17 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='12' && section=4");
 ...
 mysqli_query($conn,"UPDATE transactions SET status='Loss' where period='$current_period' && status='0' && section=4");
 $price_query = mysqli_query($conn,"SELECT SUM(amount) AS price from transactions where period='$current_period' && section=4");
 $price_result = mysqli_fetch_array($price_query);
  $price = $price_result['price'];

 mysqli_query($conn,"INSERT INTO emerd_records values('$current_period','$current_period','$price','$number','$clr')");
