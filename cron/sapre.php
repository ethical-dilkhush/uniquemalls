...
$update = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='$number' && section=2");
...
while($row = mysqli_fetch_array($update))
{
  ...
  mysqli_query($conn,"UPDATE transactions SET status='win' where period='$current_period' && selection='$number' && section=2");
}

//giving to color selectors
if($clr=='11')
{
    $query_color11 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='$clr' && section=2");
    while($row = mysqli_fetch_array($query_color11))
    {
      ...
      mysqli_query($conn,"UPDATE transactions SET status='win' where period='$current_period' && selection='$clr' && section=2");
    }
...
{
    $query_color13 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='$clr' && section=2");
...
{
    $query_color14 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='13' && section=2");
    while($row = mysqli_fetch_array($query_color14))
    {
      ...
      mysqli_query($conn,"UPDATE transactions SET status='win' where period='$current_period' && selection='13' && section=2");
    } 
    
    $query_color15 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='12' && section=2");
    while($row = mysqli_fetch_array($query_color15))
    {
      ...
      mysqli_query($conn,"UPDATE transactions SET status='win' where period='$current_period' && selection='12' && section=2");
    } 
...
{
    $query_color16 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='11' && section=2");
    while($row = mysqli_fetch_array($query_color16))
    {
      ...
      mysqli_query($conn,"UPDATE transactions SET status='win' where period='$current_period' && selection='11' && section=2");
    } 
    
    $query_color17 = mysqli_query($conn,"SELECT wallet_id,amount From transactions where period='$current_period' && selection='12' && section=2");
 ...
 mysqli_query($conn,"UPDATE transactions SET status='Loss' where period='$current_period' && status='0' && section=2");
 $price_query = mysqli_query($conn,"SELECT SUM(amount) AS price from transactions where period='$current_period' && section=2");
 $price_result = mysqli_fetch_array($price_query);
  $price = $price_result['price'];

 mysqli_query($conn,"INSERT INTO sapre_records values('$current_period','$current_period','$price','$number','$clr')");
